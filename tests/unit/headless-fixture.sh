...
source "$ROOT/tests/lib/fixture-ports.sh"
...
project=$(test_fixture_project "$fixture/debian" "$stub_dir/ports" test_fixture_port_available)
...
if test_fixture_project "$fixture/alpine" "$stub_dir/ports" > "$fixture/output" 2> "$fixture/error"; then
...
grep -Fq 'Could not reserve a fixture SSH port' "$fixture/error"
