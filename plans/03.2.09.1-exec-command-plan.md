...
`03.2.09-connection-info-and-doctor-plan.md`. The shell command (03.2.09.2)
...
03.2.11 confines the frontend `--config` option to frontend launch paths.
...
- This plan owns exec integration into 03.2.07's shared runtime matrix. Extend
  ...
  Reuse the shared expectations rather than defining a separate matrix.
